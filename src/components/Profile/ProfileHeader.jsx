...
const ProfileHeader = () => {
  ...
  return (
    <Flex gap={{ base: 4, sm: 10 }} py={10} direction={{ base: "column", sm: 'row' }}>
        <AvatarGroup size={{ base: 'xl', md: '2xl' }} justifySelf={"center"} alignSelf={'start'} mx={'auto'}>
        ...
        <VStack alignItems={'start'} gap={2} mx={'auto'} flex={1}>
            ...
            >
                ...
                {visitingAnotherProfileAndAuth && (                    
                    <Flex gap={4} alignItems={'center'} justifyContent={'center'}>
                        <Button bg={'blue.500'} color={'white'} _hover={{ bg: 'blue.600' }} onClick={handleFollowUser} isLoading={isUpdating}>
